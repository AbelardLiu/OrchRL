...
# Use the 100-step training configuration with train dataset
DEFAULT_CONFIG_NAME="search_mas_nosearch_external_roleshare_100step"
DEFAULT_CUDA_VISIBLE_DEVICES="3,4"
TIMESTAMP="$(date +%Y%m%d_%H%M%S)"
DEFAULT_LOG_PATH="$REPO_ROOT/logs/search_mas_train_100step_${TIMESTAMP}.log"
...
echo "=========================================="
echo "🚀 100-Step Long Training Configuration"
echo "=========================================="
...
echo "[INFO] Training steps: 100 (2x from 50-step baseline)"
...
echo "  ✓ Training steps: 50 → 100 (2x)"
echo "  ✓ Dataset: test_sampled → train (full training set)"
echo "  ✓ Validation frequency: 10 → 20 steps"
echo "  ✓ Sample num: 16 per step"
echo "  ✓ Batch size: 8"
echo "  ✓ Role-share: 1 shared model across 3 agents"
echo "  ✓ Model parallel: 2-GPU tensor parallelism"
echo "  ✓ Memory efficient: ~11-12GB per GPU"
